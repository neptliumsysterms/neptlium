/**
 * Neptlium Design System — Tailwind v3 theme extension
 *
 * Usage in apps/web (Tailwind v3):
 *   import baseConfig from "@neptlium/design-system/tailwind";
 *   export default { ...baseConfig, content: ["./src/**\/*.{ts,tsx}"] };
 *
 * All color values reference the CSS custom properties from tokens.css so that
